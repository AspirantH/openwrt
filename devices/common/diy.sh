...
luci-base luci-compat luci-lib-ipkg kmod-nvme libcurl luci-lib-fs coreutils coreutils-stty shadow-utils shadow-useradd mount-utils smartd mdadm libuci-lua \
wget-ssl curl autocore htop nano kmod-lib-zstd kmod-tcp-bbr kmod-tun ca-bundle ip-full ruby ruby-yaml unzip bash block-mount resolveip ds-lite swconfig luci-app-filemanager /" include/target.mk
