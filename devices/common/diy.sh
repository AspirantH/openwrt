...
luci-base luci-compat luci-lib-ipkg kmod-nvme libev libpam libtirpc liblzma libnetsnmp libcurl luci-lib-fs \
wget-ssl curl autocore htop nano kmod-lib-zstd kmod-tcp-bbr kmod-tun ca-bundle ip-full ruby ruby-yaml unzip bash tar luci-lib-jsonc block-mount resolveip ds-lite swconfig luci-app-filemanager /" include/target.mk
