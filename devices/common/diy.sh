...
luci-base luci-compat luci-lib-ipkg libev libpam libtirpc liblzma libnetsnmp kmod-oaf kmod-ipt-conntrack libubox libubus libuci libpthread libjson-c libblobmsg-json libuci-lua libsqlite3 libcurl luci-lib-fs \
